...
def smart_title(value):
    trivial_words = {
        ...
        'de', 'di', 'do', 'da', 'dos', 'das', 'em', 'no', 'na', 'nos', 'nas', 
        'por', 'pelo', 'pela', 'pelos', 'pelas', 'para', 'pra', 'pro', 'com', 'sem', 'sob', 'sobre',
        # Conjunctions
        'e', 'ou', 'mas', 'nem', 'que', 'como'
    }
    uppercase_words = {
        'CPF', 'CNPJ', 'MEI', 'LTDA', 'S/A', 'EIRELI', 'IPTU', 'IPVA', 'ISS', 'ICMS', 'PIS', 'COFINS'
    }
    if not value:
        return ""
    words = value.split()
